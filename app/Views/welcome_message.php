    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <?php if (session()->getFlashdata('erro')): ?>
                <div style="color: red; text-align: center; margin-bottom: 15px; font-family: sans-serif; font-size: 14px;">
                    <?= session()->getFlashdata('erro') ?>
                </div>
            <?php endif; ?>
            
            <?= form_open('usuariocontroller/validar', ['class' => 'form']); ?>
            <input type="email" name="email" class="input" placeholder="Email">
            <input type="password" name="senha" class="input" placeholder="Password">
            <p class="page-link">
